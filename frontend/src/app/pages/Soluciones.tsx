...
export function Soluciones() {
  const soluciones = [
    {
      icon: Network,
      title: 'Soluciones de conectividad en cobre y fibra óptica',
      items: [
        'Cableado estructurado en cobre',
        'Enlaces de fibra óptica para alta velocidad',
        'Diseño e implementación de conectividad empresarial',
      ],
    ...
    },
    {
      ...
      items: [
        ...
        'Segmentación segura por usuarios y dispositivos',
        'Monitoreo y optimización del rendimiento inalámbrico',
      ],
    ...
    },
    {
      ...
      items: [
        'Respaldo y protección eléctrica para infraestructura IT',
        'Distribución eléctrica para cuartos de equipos',
        'Continuidad operativa para plataformas críticas',
      ],
    ...
    },
    {
      ...
      items: [
        ...
        'Grabación y visualización remota',
        'Integración con monitoreo centralizado',
      ],
    ...
    },
    {
      ...
      title: 'Alarmas',
      items: [
        'Alarmas de intrusión para entornos corporativos',
    ...
    {
      icon: Building2,
      title: 'Soluciones de iluminación con diseños para oficinas modernas',
      items: [
        'Diseño lumínico para espacios de trabajo modernos',
        'Soluciones LED de alta eficiencia',
        'Integración funcional y estética del entorno',
      ],
    ...
    },
    {
      ...
      items: [
        ...
        'Automatización de procesos comerciales y de servicio',
    ...
    },
    {
      ...
      items: [
        ...
        'Atención de incidentes de software empresarial',
      ],
      image: helpDeskImg,
    },
  ];
